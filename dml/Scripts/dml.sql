...
INSERT INTO TBL_PARENT
(ID, PARENT_NAME, PARENT_ADDRESS, PARENT_PHONE)
VALUES(SEQ_PARENT.NEXTVAL, '김철수', '인천', '01012832234');
...
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '또치', 5, 1, 42);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '둘리', 7, 2, 42);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '도너', 4, 1, 41);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '마이콜', 4, 2, 43);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '짱구', 5, 2, 44);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '짱아', 5, 1, 44);
INSERT INTO TBL_CHILD
(ID, CHILD_NAME, CHILD_AGE, CHILD_GENDER, PARENT_ID)
VALUES(SEQ_CHILD.NEXTVAL, '신형만', 12, 1, 42);
...
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 42, 41);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 42, 42);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 43, 46);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 44, 47);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 41, 45);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 42, 43);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 41, 47);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 41, 41);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 44, 41);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 44, 45);
INSERT INTO TBL_APPLY
(ID, PARENT_ID, FIELD_TRIP_ID)
VALUES(SEQ_APPLY.NEXTVAL, 43, 43);
...
SELECT * FROM TBL_PARENT P1 LEFT OUTER JOIN TBL_CHILD C
